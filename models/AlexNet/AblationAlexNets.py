...
from models.TransformLayers.Shan_layers import LinearShannon, Conv2dShannon, Conv2dRealShannon
import math
...
class AbAlexNetLinearDFT(pl.LightningModule):

        def __init__(self, num_classes: int = 10, in_channels: int = 3,  dropout: float = 0.5) -> None:
            super(AbAlexNetLinearDFT, self).__init__()
...
class AbAlexNetLinearDST(pl.LightningModule):

        def __init__(self, num_classes: int = 10, in_channels: int = 3,  dropout: float = 0.5) -> None:
            super(AbAlexNetLinearDST, self).__init__()
            self.features = nn.Sequential(
            nn.Conv2d(in_channels, 64, kernel_size=11, stride=4, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=3, stride=2),
...
class AbAlexNetDFT(pl.LightningModule):

        def __init__(self, num_classes: int = 10,  in_channels: int = 3, dropout:float = 0.5) -> None:
            super(AbAlexNetDFT, self).__init__()
            self.features = nn.Sequential(
...
class AbAlexNetShannon(pl.LightningModule):

        def __init__(self, num_classes: int = 10,  in_channels: int = 3, dropout:float = 0.5) -> None:
            super(AbAlexNetShannon, self).__init__()
            self.features = nn.Sequential(
...
class AbAlexNetConvDCT(pl.LightningModule):

        def __init__(self, num_classes: int = 10,  in_channels: int = 3, dropout:float = 0.5) -> None:
            super(AbAlexNetConvDCT, self).__init__()
            self.features = nn.Sequential(
            Conv2dDCT(in_channels, 64, kernel_size=11, stride=4, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=3, stride=2),
            Conv2dDCT(64, 192, kernel_size=5, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=3, stride=2),
...
class AbAlexNetConvShannon(pl.LightningModule):

        def __init__(self, num_classes: int = 10,  in_channels: int = 3, dropout:float = 0.5) -> None:
            super(AbAlexNetConvShannon, self).__init__()
            self.features = nn.Sequential(
            Conv2dShannon(in_channels, 64, kernel_size=11, stride=4, padding=2),
            Cardioid(),
            ComplexMaxPool2d(kernel_size=3, stride=2),
...
class AbAlexNetConvRealShannon(pl.LightningModule):

        def __init__(self, num_classes: int = 10, in_channels: int = 3,  dropout: float = 0.5) -> None:
            super(AbAlexNetConvRealShannon, self).__init__()
            self.features = nn.Sequential(
