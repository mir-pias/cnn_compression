...
class AbDenseNetDFT(pl.LightningModule):
...
def _abDensenetDFT(
    ...
    **kwargs: Any,
    ...
    model = AbDenseNetDFT(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def abDensenet121DFT(*,num_classes , **kwargs: Any) -> AbDenseNetDFT:

    return _abDensenetDFT(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def abDensenet201DFT(*,num_classes , **kwargs: Any) -> AbDenseNetDFT:

    return _abDensenetDFT(32, (6, 12, 48, 32), 64, num_classes, **kwargs)