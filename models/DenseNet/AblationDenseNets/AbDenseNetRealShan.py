...
class AbDenseNetRealShan(pl.LightningModule):
...
def _abDensenetRealShan(
    ...
    **kwargs: Any,
    ...
    model = AbDenseNetRealShan(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def abDensenet121RealShan(*,num_classes , **kwargs: Any) -> AbDenseNetRealShan:

    return _abDensenetRealShan(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def abDensenet201RealShan(*,num_classes , **kwargs: Any) -> AbDenseNetRealShan:

    return _abDensenetRealShan(32, (6, 12, 48, 32), 64, num_classes, **kwargs)