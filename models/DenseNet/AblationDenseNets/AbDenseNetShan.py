...
class AbDenseNetShan(pl.LightningModule):
...
def _abDensenetShan(
    ...
    **kwargs: Any,
    ...
    model = AbDenseNetShan(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def abDensenet121Shan(*,num_classes , **kwargs: Any) -> AbDenseNetShan:

    return _abDensenetShan(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def abDensenet201Shan(*,num_classes , **kwargs: Any) -> AbDenseNetShan:

    return _abDensenetShan(32, (6, 12, 48, 32), 64, num_classes, **kwargs)