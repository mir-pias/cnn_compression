...
def _densenetLinearDCT(
    ...
    **kwargs: Any,
    ...
    model = DenseNetLinearDCT(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121LinearDCT(num_classes , **kwargs: Any) -> DenseNetLinearDCT:
   

    return _densenetLinearDCT(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201LinearDCT(num_classes , **kwargs: Any) -> DenseNetLinearDCT:


    return _densenetLinearDCT(32, (6, 12, 48, 32), 64, num_classes, **kwargs)