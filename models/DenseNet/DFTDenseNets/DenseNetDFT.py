...
class DenseNetDFT(pl.LightningModule):
    ...
    def __init__(
        ...
        # Linear layer
        self.classifier = LinearDFT(num_features, num_classes)
...
def _densenetDFT(
    ...
    **kwargs: Any,
    ...
    model = DenseNetDFT(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121DFT(*,num_classes , **kwargs: Any) -> DenseNetDFT:

    return _densenetDFT(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201DFT(*,num_classes , **kwargs: Any) -> DenseNetDFT:

    return _densenetDFT(32, (6, 12, 48, 32), 64, num_classes, **kwargs)