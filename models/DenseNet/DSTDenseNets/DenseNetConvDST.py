...
from models.TransformLayers.DST_layers import Conv2dDST
...
class DenseNetConvDST(pl.LightningModule):
...
def _densenetConvDST(
    ...
    **kwargs: Any,
    ...
    model = DenseNetConvDST(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121ConvDST(*,num_classes , **kwargs: Any) -> DenseNetConvDST:

    return _densenetConvDST(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201ConvDST(*,num_classes , **kwargs: Any) -> DenseNetConvDST:

    return _densenetConvDST(32, (6, 12, 48, 32), 64, num_classes, **kwargs)