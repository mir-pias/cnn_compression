...
class DenseNetConvShan(pl.LightningModule):
...
def _densenetConvShan(
    ...
    **kwargs: Any,
    ...
    model = DenseNetConvShan(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121ConvShan(*,num_classes , **kwargs: Any) -> DenseNetConvShan:

    return _densenetConvShan(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201ConvShan(*,num_classes , **kwargs: Any) -> DenseNetConvShan:

    return _densenetConvShan(32, (6, 12, 48, 32), 64, num_classes, **kwargs)