...
class DenseNetConvShannon(pl.LightningModule):
...
def _densenetConvShannon(
    ...
    **kwargs: Any,
    ...
    model = DenseNetConvShannon(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121ConvShannon(*,num_classes , **kwargs: Any) -> DenseNetConvShannon:

    return _densenetConvShannon(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201ConvShannon(*,num_classes , **kwargs: Any) -> DenseNetConvShannon:

    return _densenetConvShannon(32, (6, 12, 48, 32), 64, num_classes, **kwargs)