...
class DenseNetLinearRealShannon(pl.LightningModule):
...
def _densenetLinearRealShannon(
    growth_rate: int,
    block_config: Tuple[int, int, int, int],
    num_init_features: int,
    num_classes: int,
    **kwargs: Any,
) -> DenseNetLinearRealShannon:

    model = DenseNetLinearRealShannon(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121LinearRealShannon(num_classes , **kwargs: Any) -> DenseNetLinearRealShannon:
   

    return _densenetLinearRealShannon(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201LinearRealShannon(num_classes , **kwargs: Any) -> DenseNetLinearRealShannon:


    return _densenetLinearRealShannon(32, (6, 12, 48, 32), 64, num_classes, **kwargs)