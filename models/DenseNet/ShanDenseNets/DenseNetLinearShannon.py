...
class DenseNetLinearShannon(pl.LightningModule):
...
def _densenetLinearShannon(
    growth_rate: int,
    block_config: Tuple[int, int, int, int],
    num_init_features: int,
    num_classes: int,
    **kwargs: Any,
) -> DenseNetLinearShannon:

    model = DenseNetLinearShannon(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121LinearShannon(*,num_classes , **kwargs: Any) -> DenseNetLinearShannon:
   

    return _densenetLinearShannon(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201LinearShannon(*,num_classes , **kwargs: Any) -> DenseNetLinearShannon:


    return _densenetLinearShannon(32, (6, 12, 48, 32), 64, num_classes, **kwargs)