...
from models.TransformLayers.Shan_layers import Conv2dShannon, LinearShannon
...
class DenseNetShannon(pl.LightningModule):
...
def _densenetShannon(
    ...
    **kwargs: Any,
    ...
    model = DenseNetShannon(growth_rate, block_config, num_init_features, num_classes, **kwargs)
    return model

def densenet121Shannon(*,num_classes , **kwargs: Any) -> DenseNetShannon:

    return _densenetShannon(32, (6, 12, 24, 16), 64, num_classes, **kwargs)

def densenet201Shannon(*,num_classes , **kwargs: Any) -> DenseNetShannon:

    return _densenetShannon(32, (6, 12, 48, 32), 64, num_classes, **kwargs)