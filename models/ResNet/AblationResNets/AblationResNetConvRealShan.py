...
class AblationResNetConvRealShan(pl.LightningModule):
    def __init__(
        self,
...
def _ablationResnetConvRealShan(
    block: Type[Union[BasicBlock, Bottleneck]],
    layers: List[int],
    num_classes: int,
    **kwargs: Any,
) -> AblationResNetConvRealShan:

    model = AblationResNetConvRealShan(block, layers, num_classes, **kwargs)

    return model

def ablationResnet18ConvRealShan(*, num_classes, **kwargs: Any) -> AblationResNetConvRealShan:
   
    return _ablationResnetConvRealShan(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def ablationResnet50ConvRealShan(*, num_classes, **kwargs: Any) -> AblationResNetConvRealShan:

    return _ablationResnetConvRealShan(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)