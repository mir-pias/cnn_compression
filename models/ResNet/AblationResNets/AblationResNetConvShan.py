...
class AblationResNetConvShan(pl.LightningModule):
    def __init__(
        self,
...
def _ablationResnetConvShan(
    block: Type[Union[BasicBlock, Bottleneck]],
    layers: List[int],
    num_classes: int,
    **kwargs: Any,
) -> AblationResNetConvShan:

    model = AblationResNetConvShan(block, layers, num_classes, **kwargs)

    return model

def ablationResnet18ConvShan(*, num_classes, **kwargs: Any) -> AblationResNetConvShan:

    return _ablationResnetConvShan(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def ablationResnet50ConvShan(*, num_classes, **kwargs: Any) -> AblationResNetConvShan:

    return _ablationResnetConvShan(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)