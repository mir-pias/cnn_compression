...
class AblationResNetDFT(pl.LightningModule):
    def __init__(
        self,
...
def _ablationResnetDFT(
    ...
    **kwargs: Any,
    ...
    model = AblationResNetDFT(block, layers, num_classes, **kwargs)

    return model

def ablationResnet18DFT(*, num_classes, **kwargs: Any) -> AblationResNetDFT:

    return _ablationResnetDFT(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def ablationResnet50DFT(*, num_classes, **kwargs: Any) -> AblationResNetDFT:

    return _ablationResnetDFT(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)