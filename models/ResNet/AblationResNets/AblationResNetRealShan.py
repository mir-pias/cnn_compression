...
# from models.TransformLayers.conv2d_dct import Conv2dShannon
from models.TransformLayers.Shan_layers import Conv2dRealShannon, LinearRealShannon
...
class AblationResNetRealShan(pl.LightningModule):
    def __init__(
        self,
...
def _ablationResnetRealShan(
    block: Type[Union[BasicBlock, Bottleneck]],
    layers: List[int],
    num_classes: int,
    **kwargs: Any,
) -> AblationResNetRealShan:

    model = AblationResNetRealShan(block, layers, num_classes, **kwargs)

    return model

def ablationResnet18RealShan(*, num_classes, **kwargs: Any) -> AblationResNetRealShan:

    return _ablationResnetRealShan(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def ablationResnet50RealShan(*, num_classes, **kwargs: Any) -> AblationResNetRealShan:

    return _ablationResnetRealShan(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)