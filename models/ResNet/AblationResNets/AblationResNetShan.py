...
# from models.TransformLayers.conv2d_dft import Conv2dShannon
...
class AblationResNetShan(pl.LightningModule):
    def __init__(
        self,
...
def _ablationResnetShan(
    ...
    **kwargs: Any,
    ...
    model = AblationResNetShan(block, layers, num_classes, **kwargs)

    return model

def ablationResnet18Shan(*, num_classes, **kwargs: Any) -> AblationResNetShan:

    return _ablationResnetShan(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def ablationResnet50Shan(*, num_classes, **kwargs: Any) -> AblationResNetShan:

    return _ablationResnetShan(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)