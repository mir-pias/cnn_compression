...
class Bottleneck(nn.Module):
    ...
    # This variant is also known as ResNetLinearDFT V1.5 and improves accuracy according to
...
class ResNetLinearDFT(pl.LightningModule):
    def __init__(
        self,
...
def _resnetLinearDFT(
    ...
    **kwargs: Any,
    ...
    model = ResNetLinearDFT(block, layers, num_classes, **kwargs)
