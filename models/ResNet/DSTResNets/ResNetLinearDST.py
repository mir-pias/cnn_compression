...
class Bottleneck(nn.Module):
    ...
    # This variant is also known as ResNetLinearDST V1.5 and improves accuracy according to
...
class ResNetLinearDST(pl.LightningModule):
    def __init__(
        self,
...
def _resnetLinearDST(
    ...
    **kwargs: Any,
    ...
    model = ResNetLinearDST(block, layers, num_classes, **kwargs)
