...
class ResNetConvShannon(pl.LightningModule):
    def __init__(
        self,
...
def _resnetConvShannon(
    ...
    **kwargs: Any,
    ...
    model = ResNetConvShannon(block, layers, num_classes, **kwargs)

    return model

def resnet18ConvShannon(*, num_classes, **kwargs: Any) -> ResNetConvShannon:

    return _resnetConvShannon(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def resnet50ConvShannon(*, num_classes, **kwargs: Any) -> ResNetConvShannon:

    return _resnetConvShannon(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)