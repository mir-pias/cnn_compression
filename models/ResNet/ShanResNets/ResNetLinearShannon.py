...
class ResNetLinearShannon(pl.LightningModule):
    def __init__(
        self,
...
def _resnetLinearShannon(
    ...
    **kwargs: Any,
    ...
    model = ResNetLinearShannon(block, layers, num_classes, **kwargs)

    return model

def resnet18LinearShannon(*, num_classes, **kwargs: Any) -> ResNetLinearShannon:
    
    return _resnetLinearShannon(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def resnet50LinearShannon(*, num_classes, **kwargs: Any) -> ResNetLinearShannon:

    return _resnetLinearShannon(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)