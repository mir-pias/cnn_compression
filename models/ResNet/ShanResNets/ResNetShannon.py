...
class ResNetShannon(pl.LightningModule):
    def __init__(
        self,
...
def _resnetShannon(
    ...
    **kwargs: Any,
    ...
    model = ResNetShannon(block, layers, num_classes, **kwargs)

    return model

def resnet18Shannon(*, num_classes, **kwargs: Any) -> ResNetShannon:

    return _resnetShannon(BasicBlock, [2, 2, 2, 2], num_classes, **kwargs)

def resnet50Shannon(*, num_classes, **kwargs: Any) -> ResNetShannon:

    return _resnetShannon(Bottleneck, [3, 4, 6, 3], num_classes, **kwargs)