...
if __name__ == '__main__':
    ...
    from models.DFT_alexnets_cifar10 import AlexNetLinearDFT
    ...
    net = AlexNetLinearDFT(num_classes=10).to(device)
    print(net)
    ...
    file = open('py_outputs/dft_fc_alexnet_py_output.txt','w')


    print("AlexNetLinearDFT......")
    file.write("AlexNetLinearDFT...... \n \n" )
    epochs = 5
