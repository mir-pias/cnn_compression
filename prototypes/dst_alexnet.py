...
if __name__ == '__main__':
    ...
    from models.DST_alexnets_cifar10 import AlexnetDST
    ...
    net = AlexnetDST(num_classes=10).to(device)
    print(net)
    ...
    print("AlexnetDST.....Conv2dDST + LinearDST")
    file.write("AlexnetDST.....Conv2dDST + LinearDST \n \n")
    epochs = 5
