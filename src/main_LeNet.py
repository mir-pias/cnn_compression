...
from utils.model_select import model_select_LeNet
...
def main(inputs):
    ...
    ## model init
    model , model_name = model_select_LeNet(inputs.kernel, inputs.layers, num_classes)
    print(model)
    ...
    try:
        expt_id = mlflow.create_experiment("LeNets")
    except mlflow.exceptions.MlflowException:
        expt = mlflow.get_experiment_by_name('LeNets')
